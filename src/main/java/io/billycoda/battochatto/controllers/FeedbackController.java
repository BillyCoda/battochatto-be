package io.billycoda.battochatto.controllers;

import io.billycoda.battochatto.models.Feedback;
import io.billycoda.battochatto.services.FeedbackService;
...
public class FeedbackController {
    ...
    public ResponseEntity<List<Feedback>> findFeedbackByUserId(@RequestParam String userId) {
